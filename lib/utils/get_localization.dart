...
,"en" : {
    ...
    "batteryOptPromptTitle": "Disable battery optimization?",
    "batteryOptPromptBody": "Android may pause music when the screen is off. Allowing doudou to ignore battery optimization keeps playback running in the background.",
    "batteryOptPromptLater": "Maybe later",
    "status": "Status",
    "enabled": "Enabled",
    "disabled": "Disabled",
...
,"vi" : {
    ...
    "batteryOptPromptTitle": "关闭电池优化？",
    "batteryOptPromptBody": "安卓可能会在息屏时暂停音乐。允许 doudou 忽略电池优化可以让播放持续在后台运行。",
    "batteryOptPromptLater": "以后再说",
    "status": "状态",
    "enabled": "已启用",
    "disabled": "已禁用",
    "github": "GitHub",
...
,"zh-TW" : {
    ...
    "batteryOptPromptTitle": "關閉電池最佳化？",
    "batteryOptPromptBody": "安卓可能會在息屏時暫停音樂。允許 doudou 忽略電池最佳化可以讓播放持續在背景執行。",
    "batteryOptPromptLater": "以後再說",
