...
class DesktopTheme {
  ...
  static bool get _useOledBlack => _isDark && _oled;
  ...
  static Color get backgroundDeep =>
      _useOledBlack ? _black : (_isDark ? backgroundDeepDark : backgroundDeepLight);
  ...
  static Color get backgroundPrimary =>
      _useOledBlack ? _black : (_isDark ? backgroundPrimaryDark : backgroundPrimaryLight);
  ...
  static Color get backgroundSecondary =>
      _useOledBlack ? _black : (_isDark ? backgroundSecondaryDark : backgroundSecondaryLight);
  ...
  static Color get backgroundTertiary =>
      _useOledBlack ? _black : (_isDark ? backgroundTertiaryDark : backgroundTertiaryLight);
  ...
  static Color get backgroundElevated =>
      _useOledBlack ? _black : (_isDark ? backgroundElevatedDark : backgroundElevatedLight);
  ...
  static Color get glassSurface =>
      _useOledBlack ? _black : (_isDark ? glassSurfaceDark : glassSurfaceLight);
