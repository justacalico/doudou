                  ...
                  child: GestureDetector(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        decorationColor: DesktopTheme.textTertiary.withOpacity(0.5),
                      ),
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                    ),
                                                    ...
                                                    child: Text(
                                                      ...
                                                      style: TextStyle(
                                                        ...
                                                        color:
                                                            DesktopTheme.textPrimary,
                                                        decoration: TextDecoration.underline,
                                                        decorationColor: DesktopTheme.textPrimary
                                                            .withOpacity(0.5),
                                                      ),
                                                      overflow: TextOverflow.ellipsis,
                                                    ),
...
class _NowPlayingMain extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final l10n = AppLocalizations.of(context);
    // Show album for all providers if album data exists (not 'Unknown Album')
                      ...
                      MouseRegion(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            ...
                            final albumName = widget.track.albumName;
                            if (albumId != null) {
                              final album = widget.appState.albums
                                  .where((a) => a.id == albumId)
                                  .firstOrNull;
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              fontSize: 11,
                              color: DesktopTheme.textTertiary.withOpacity(0.8),
                              decoration: TextDecoration.underline,
                              decorationColor: DesktopTheme.textTertiary
                                  .withOpacity(0.4),
                            ),
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis,
...
class _DetailHeaderState extends State<_DetailHeader> {
  ...
  Future<void> _loadGradientColors() async {
    if (widget.imageUrl == null || widget.imageUrl!.isEmpty) {
      setState(() => _gradientColors = null);
      return;
    }

    final colors = await AlbumArtColorService.getGradientColors(widget.imageUrl!);
    if (mounted) {
      setState(() => _gradientColors = colors);
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    // Use extracted gradient colors if available, otherwise fall back to theme-based gradient
    final gradientColors = _gradientColors != null && _gradientColors!.length >= 3
        ? [
          ...
          Row(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(
                    widget.isCircular ? 96 : DesktopTheme.radiusLg,
                  ),
                  color: DesktopTheme.backgroundElevated,
                  boxShadow: [
                    BoxShadow(
