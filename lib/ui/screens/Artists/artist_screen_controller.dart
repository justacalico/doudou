  ...
  String get artistTotalDurationFormatted {
    ...
    for (final item in list) {
      ...
      if (item.duration != null) {
        totalSeconds += item.duration!.inSeconds;
      } else if (item.extras != null && item.extras!['length'] != null) {
        final sec = parseDuration(item.extras!['length']?.toString());
        if (sec != null) totalSeconds += sec;
      }
    }
