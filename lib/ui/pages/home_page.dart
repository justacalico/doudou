...
class _HomePageState extends State<HomePage> {
              ...
              : SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // YouTube Music: show curated home sections (recommendations, quick picks, etc.)
                      if (appState.mediaServiceManager.currentServerType ==
                              ServerType.youtubeMusic &&
                          appState.youtubeMusicHomeSections.isNotEmpty) ...[
                        ...appState.youtubeMusicHomeSections.map((section) {
                          return Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              SectionHeader(
                              ...
                              const SizedBox(height: DesktopTheme.spacingMd),
                              _ytHomeSectionContent(
                                  context, appState, l10n, section),
                              const SizedBox(height: DesktopTheme.spacingXl),
                            ],
                          );
                        }),
  ...
  /// One section from YouTube Music home (albums, playlists, or tracks row).
  Widget _ytHomeSectionContent(
    ...
    if (section.playlists.isNotEmpty) {
      if (children.isNotEmpty) {
        children.add(const SizedBox(height: DesktopTheme.spacingMd));
      }
      children.add(
        SizedBox(
          height: 230,
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Padding(
                padding: EdgeInsets.only(
                  right: index < section.playlists.length - 1
                      ? DesktopTheme.spacingMd
                      : 0,
                ),
                child: MusicCard(
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Padding(
                padding: EdgeInsets.only(
                  right: index < section.tracks.length - 1
                      ? DesktopTheme.spacingMd
                      : 0,
                ),
                child: MusicCard(
                  ...
                  size: 180,
                  onTap: () => appState.playPlaylist(section.tracks, index),
                ),
              );
            },
          ),
