...
- Pressing back on the home tab no longer quits the app instantly. A "press back again to exit" prompt appears first, and only a second press within two seconds actually exits.
