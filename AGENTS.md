...
5. Write tests for EVERY new thing you do any code change should be testable no matter how small it is write the test. Make sure tests are created just to pass they should test the actural changes.
